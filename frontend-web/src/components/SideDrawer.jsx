...
const SideDrawer = ({ isOpen, onClose }) => {
  ...
  const images = [
    ...
    "https://images.unsplash.com/photo-1514516430037-4f71c7d1c4d0",
  ...
  return (
    <div className="fixed inset-0 z-[999] hidden lg:flex">
      ...
      <motion.div
        ...
        className="relative ml-auto w-[420px] h-full bg-[#F5EFEA] p-10 flex flex-col overflow-y-auto"
      >

        {/* ❌ Close */}
        <button
          onClick={onClose}
          className="absolute top-6 right-6 text-2xl text-[#8B6B4A]"
        >
          ✕
        </button>
