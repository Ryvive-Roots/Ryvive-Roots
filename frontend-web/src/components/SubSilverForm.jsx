...
const inputStyle = `
  ...
  px-4 py-3 text-sm text-gray-800 shadow-sm
    ...
    <div className="max-w-7xl mx-auto my-30 px-4">
      ...
      <div className="flex justify-center">
        <div className="w-full max-w-5xl">
          <div className="bg-white/70 backdrop-blur-xl  rounded-3xl p-6 md:p-10 shadow-xl">
            <h2 className="text-2xl font-semibold font-fredoka mb-1">
              {steps[step]}
            </h2>
              ...
              <div className="grid md:grid-cols-2 font-roboto gap-4">
                ...
                <div className="relative group">
                  <select
                    ...
                    value={
                      deliverySlot.type === "morning" ? deliverySlot.time : ""
                    }
                    onChange={(e) => {
                ...
                <div className="relative group">
                  <select
                    ...
                    value={
                      deliverySlot.type === "evening" ? deliverySlot.time : ""
                    }
                    onChange={(e) => {
                      const slotValue = e.target.value;
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-500 mt-1">
                    Please review your subscription details before placing the
                    order.
                  </p>
                </div>
